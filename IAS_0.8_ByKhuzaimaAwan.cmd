...
cls
title  Activation_Script(IDM) - @Khuzaima_Awan_47
mode 65, 25
...
call :_color2 %_White% "        " %_Green% "  Created By Khuzaima_Awan_47"
echo:          ________________________________________________   
echo: 
echo:          Pr0j3ctFr33IDM
echo:          https://github.com/KhuzaimaAwan47/Pr0j3ctFr33IDM
echo:          ________________________________________________   
echo:                                                          
echo:          [1] Activate IDM                                
...
start https://github.com/KhuzaimaAwan47/Pr0j3ctFr33IDM
goto MainMenu
...
If not defined name set name=Khuzaima_Awan
